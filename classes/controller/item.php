...
* @subpackage	
*/
class ConfmgtCkClassControllerItem extends JControllerForm
{
	/**
	...
	* @var string
	*/
	protected $text_prefix = 'COM_CONFMGT';
	...
	*/
	public function add()
	{
		...
		$this->applyRedirection($result, array(
			'com_confmgt.' . $this->view_list . '.default',
			'com_confmgt.' . $this->view_item . '.' . $this->getLayout('edit')
		));
	}
	...
	*/
	public function delete()
	{
		...
		else
		{
			...
			{
				$result = true;
				$this->setMessage(JText::plural('CONFMGT_ITEMS_SUCCESSFULLY_DELETED', count($cid)));
			}
			else
			{
...
JLoader::register('ConfmgtClassControllerItem', JPATH_ADMIN_CONFMGT .DS. 'fork' .DS. 'classes' .DS. 'controller' .DS. 'item.php');
JLoader::load('ConfmgtClassControllerItem');
// Fallback if no fork has been found
if (!class_exists('ConfmgtClassControllerItem')){ class ConfmgtClassControllerItem extends ConfmgtCkClassControllerItem{} }
