	...
	<table class='table' id='grid-presentation'>
		<thead>
			<tr>
				...
				<th>
					<?php echo JHTML::_('grid.sort',  "CONFMGT_FIELD_MODIFICATION_DATE", 'a.modification_date', $listDirn, $listOrder ); ?>
				</th>
				...
				<th style="text-align:center">
					<?php echo JHTML::_('grid.sort',  "CONFMGT_FIELD_PAID_AND_REGISTERED", '_presenter_.paid_and_registered', $listDirn, $listOrder ); ?>
				</th>
			</tr>
		</thead>
		<tbody>
