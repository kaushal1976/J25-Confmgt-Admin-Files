...
class ConfmgtCkViewCamerareadyitem extends ConfmgtClassView
{
	...
	*/
	public function display($tpl = null)
	{
		...
		if (in_array($layout, array('camerareadyitem', 'camerareadyitemview')))
		{
...
JLoader::register('ConfmgtViewCamerareadyitem', JPATH_ADMIN_CONFMGT .DS. 'fork' .DS. 'views' .DS. 'camerareadyitem' .DS. 'view.html.php');
