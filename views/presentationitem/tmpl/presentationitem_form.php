...
?>
<?php $fieldSet = $this->form->getFieldset('presentationitem.form');?>
<fieldset class="fieldsform form-horizontal">
	...
	$fieldSet['jform_presenter']->jdomOptions = array(
			'list' => $this->lists['fk']['presenter']
		);
	$fieldSet['jform_presentation']->jdomOptions = array(
