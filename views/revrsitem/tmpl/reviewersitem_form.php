...
?>
<?php $fieldSet = $this->form->getFieldset('reviewersitem.form');?>
<fieldset class="fieldsform form-horizontal">
	<legend><?php echo JText::_($fieldSets['reviewersitem.form']->label);?></legend>

	<?php
	// JForms dynamic initialization (Cook Self Service proposal)
	$fieldSet['jform_title']->jdomOptions = array(
			'list' => $this->lists['select']['title']->list
		);
