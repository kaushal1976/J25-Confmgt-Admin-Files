	...
	<table class='table' id='grid-revs'>
		<thead>
			<tr>
				...
				<th>
					<?php echo JText::_("CONFMGT_FIELD_COMMENTS_TO_THE_COORDINATOR_1"); ?>
				</th>
				...
				<th>
					<?php echo JHTML::_('grid.sort',  "CONFMGT_FIELD_RECOMMONDATION_1", 'a.recommondation', $listDirn, $listOrder ); ?>
				</th>
