...
* @subpackage	Users
*/
class ConfmgtCkViewThirdusers extends ConfmgtClassView
{
	/**
	...
	*/
	protected function displayAjax($tpl = null)
	{
		...
		switch($render)
		{
			case 'select1':
			/* Ajax List : Users
			 * Called from: view:revsitem, layout:rev
			 */
				$model = $this->getModel();
				...
				$event = 'jQuery("#jform_reviewer").val(this.value);';
				...
				echo '<div class="ajaxchain-filter ajaxchain-filter-hz">';
					echo '<div class="separator">';
						echo JDom::_('html.form.input.select', array(
							...
							'list' => $items,
							'listKey' => 'id',
							'nullLabel' => 'CONFMGT_FILTER_NULL_USER',
							'selectors' => array(
									'onchange' => $event
								)
							));
...
JLoader::register('ConfmgtViewThirdusers', JPATH_ADMIN_CONFMGT .DS. 'fork' .DS. 'views' .DS. 'thirdusers' .DS. 'view.html.php');
JLoader::load('ConfmgtViewThirdusers');
// Fallback if no fork has been found
if (!class_exists('ConfmgtViewThirdusers')){ class ConfmgtViewThirdusers extends ConfmgtCkViewThirdusers{} }
