...
class ConfmgtCkHelperDates
{
	...
	*/
	static function getSqlDate($strtime, $formats)
	{
		...
		foreach($formats as $format)
		{
			...
			if (preg_match($regex, $strtime))
				return new JDate(self::timeFromFormat($strtime, $format));
		}
	}
	...
	*/
	static function getUnixTimestamp($strtime, $formats)
	{
...
JLoader::register('ConfmgtHelperDates', JPATH_ADMIN_CONFMGT .DS. 'fork' .DS. 'helpers' .DS. 'dates.php');
JLoader::load('ConfmgtHelperDates');
// Fallback if no fork has been found
if (!class_exists('ConfmgtHelperDates')){ class ConfmgtHelperDates extends ConfmgtCkHelperDates{} }
