...
class ConfmgtCkControllerPresentationitem extends ConfmgtClassControllerItem
{
	...
	public function add()
	{
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			...
			default:
				$this->applyRedirection($result, array(
					'stay',
					'com_confmgt.presentationitem.presentationitemview'
				));
				break;
		}
	}
	...
	*/
	protected function getLayout($default = null)
	{
		...
		return $jinput->get('layout', 'presentationitemview', 'CMD');
	}
...
JLoader::register('ConfmgtControllerPresentationitem', JPATH_ADMIN_CONFMGT .DS. 'fork' .DS. 'controllers' .DS. 'presentationitem.php');
