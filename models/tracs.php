...
* @subpackage	Classes
*/
class ConfmgtCkModelTracs extends ConfmgtClassModelList
{
	/**
...
JLoader::register('ConfmgtModelTracs', JPATH_ADMIN_CONFMGT .DS. 'fork' .DS. 'models' .DS. 'tracs.php');
JLoader::load('ConfmgtModelTracs');
// Fallback if no fork has been found
if (!class_exists('ConfmgtModelTracs')){ class ConfmgtModelTracs extends ConfmgtCkModelTracs{} }
