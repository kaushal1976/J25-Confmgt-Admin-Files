...
class ConfmgtCkModelPresentationitem extends ConfmgtClassModelItem
{
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'presentationitemview', 'STRING');
	}
...
JLoader::register('ConfmgtModelPresentationitem', JPATH_ADMIN_CONFMGT .DS. 'fork' .DS. 'models' .DS. 'presentationitem.php');
