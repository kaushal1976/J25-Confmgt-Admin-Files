...
* @subpackage	Classes
*/
class ConfmgtCkModelCamera extends ConfmgtClassModelList
{
	/**
	...
	public function __construct($config = array())
	{
		...
		if (empty($config['filter_fields'])) {
			$config['filter_fields'] = array(
				'paper_id', 'a.paper_id',
				'title', 'a.title',
				'copyright_transfer', 'a.copyright_transfer',
				'publish', 'a.publish',
	...
	*/
	protected function prepareQuery(&$query)
	{
		...
		//WHERE - SEARCH : search_search_1 : search on Paper ID > Title + Paper ID > Key words
		...
		//WHERE - SEARCH : search_search_2 : search on Paper ID > Title + Paper ID > Key words
...
JLoader::register('ConfmgtModelCamera', JPATH_ADMIN_CONFMGT .DS. 'fork' .DS. 'models' .DS. 'camera.php');
JLoader::load('ConfmgtModelCamera');
// Fallback if no fork has been found
if (!class_exists('ConfmgtModelCamera')){ class ConfmgtModelCamera extends ConfmgtCkModelCamera{} }
