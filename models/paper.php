...
class ConfmgtCkModelPaper extends ConfmgtClassModelItem
{
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'fullpaperreview', 'STRING');
	}
...
JLoader::register('ConfmgtModelPaper', JPATH_ADMIN_CONFMGT .DS. 'fork' .DS. 'models' .DS. 'paper.php');
