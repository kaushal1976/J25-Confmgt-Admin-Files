...
* @subpackage	Form
*/
class ConfmgtCkFormRulePositiveinteger extends ConfmgtClassFormRule
{
	/**
...
JLoader::register('JFormRulePositiveinteger', JPATH_ADMIN_CONFMGT .DS. 'fork' .DS. 'models' .DS. 'rules' .DS. 'positiveinteger.php');
JLoader::load('JFormRulePositiveinteger');
// Fallback if no fork has been found
if (!class_exists('JFormRulePositiveinteger')){ class JFormRulePositiveinteger extends ConfmgtCkFormRulePositiveinteger{} }
