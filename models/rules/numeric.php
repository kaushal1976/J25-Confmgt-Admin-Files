...
* @subpackage	Form
*/
class ConfmgtCkFormRuleNumeric extends ConfmgtClassFormRule
{
	/**
...
JLoader::register('JFormRuleNumeric', JPATH_ADMIN_CONFMGT .DS. 'fork' .DS. 'models' .DS. 'rules' .DS. 'numeric.php');
JLoader::load('JFormRuleNumeric');
// Fallback if no fork has been found
if (!class_exists('JFormRuleNumeric')){ class JFormRuleNumeric extends ConfmgtCkFormRuleNumeric{} }
