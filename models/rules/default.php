...
* @subpackage	Form
*/
class ConfmgtCkFormRuleDefault extends ConfmgtClassFormRule
{
	/**
...
JLoader::register('JFormRuleDefault', JPATH_ADMIN_CONFMGT .DS. 'fork' .DS. 'models' .DS. 'rules' .DS. 'default.php');
JLoader::load('JFormRuleDefault');
// Fallback if no fork has been found
if (!class_exists('JFormRuleDefault')){ class JFormRuleDefault extends ConfmgtCkFormRuleDefault{} }
