...
* @subpackage	Form
*/
class ConfmgtCkFormFieldCklimit extends ConfmgtClassFormField
{
	/**
	* The form field type.
	*
...
JLoader::register('JFormFieldCklimit', JPATH_ADMIN_CONFMGT .DS. 'fork' .DS. 'models' .DS. 'fields' .DS. 'cklimit.php');
JLoader::load('JFormFieldCklimit');
// Fallback if no fork has been found
if (!class_exists('JFormFieldCklimit')){ class JFormFieldCklimit extends ConfmgtCkFormFieldCklimit{} }
