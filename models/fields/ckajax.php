...
* @subpackage	Form
*/
class ConfmgtCkFormFieldCkajax extends ConfmgtClassFormField
{
	/**
	* The form field type.
	*
...
JLoader::register('JFormFieldCkajax', JPATH_ADMIN_CONFMGT .DS. 'fork' .DS. 'models' .DS. 'fields' .DS. 'ckajax.php');
JLoader::load('JFormFieldCkajax');
// Fallback if no fork has been found
if (!class_exists('JFormFieldCkajax')){ class JFormFieldCkajax extends ConfmgtCkFormFieldCkajax{} }
