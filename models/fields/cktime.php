...
* @subpackage	Form
*/
class ConfmgtCkFormFieldCktime extends ConfmgtClassFormField
{
	/**
	* The form field type.
	*
...
JLoader::register('JFormFieldCktime', JPATH_ADMIN_CONFMGT .DS. 'fork' .DS. 'models' .DS. 'fields' .DS. 'cktime.php');
JLoader::load('JFormFieldCktime');
// Fallback if no fork has been found
if (!class_exists('JFormFieldCktime')){ class JFormFieldCktime extends ConfmgtCkFormFieldCktime{} }
