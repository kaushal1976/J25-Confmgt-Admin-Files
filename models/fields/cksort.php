...
* @subpackage	Form
*/
class ConfmgtCkFormFieldCksort extends ConfmgtClassFormField
{
	/**
	* The form field type.
	*
...
JLoader::register('JFormFieldCksort', JPATH_ADMIN_CONFMGT .DS. 'fork' .DS. 'models' .DS. 'fields' .DS. 'cksort.php');
JLoader::load('JFormFieldCksort');
// Fallback if no fork has been found
if (!class_exists('JFormFieldCksort')){ class JFormFieldCksort extends ConfmgtCkFormFieldCksort{} }
