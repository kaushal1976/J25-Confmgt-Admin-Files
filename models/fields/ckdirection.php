...
* @subpackage	Form
*/
class ConfmgtCkFormFieldCkdirection extends ConfmgtClassFormField
{
	/**
	* The form field type.
	*
...
JLoader::register('JFormFieldCkdirection', JPATH_ADMIN_CONFMGT .DS. 'fork' .DS. 'models' .DS. 'fields' .DS. 'ckdirection.php');
JLoader::load('JFormFieldCkdirection');
// Fallback if no fork has been found
if (!class_exists('JFormFieldCkdirection')){ class JFormFieldCkdirection extends ConfmgtCkFormFieldCkdirection{} }
