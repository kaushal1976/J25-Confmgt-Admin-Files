...
* @subpackage	Form
*/
class ConfmgtCkFormFieldCkstate extends ConfmgtClassFormField
{
	/**
	* The form field type.
	*
...
JLoader::register('JFormFieldCkstate', JPATH_ADMIN_CONFMGT .DS. 'fork' .DS. 'models' .DS. 'fields' .DS. 'ckstate.php');
JLoader::load('JFormFieldCkstate');
// Fallback if no fork has been found
if (!class_exists('JFormFieldCkstate')){ class JFormFieldCkstate extends ConfmgtCkFormFieldCkstate{} }
