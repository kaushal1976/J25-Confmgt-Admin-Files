...
* @subpackage	Form
*/
class ConfmgtCkFormFieldCksearch extends ConfmgtClassFormField
{
	/**
	* The form field type.
	*
...
JLoader::register('JFormFieldCksearch', JPATH_ADMIN_CONFMGT .DS. 'fork' .DS. 'models' .DS. 'fields' .DS. 'cksearch.php');
JLoader::load('JFormFieldCksearch');
// Fallback if no fork has been found
if (!class_exists('JFormFieldCksearch')){ class JFormFieldCksearch extends ConfmgtCkFormFieldCksearch{} }
