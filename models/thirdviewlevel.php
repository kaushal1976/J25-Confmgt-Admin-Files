...
* @subpackage	Classes
*/
class ConfmgtCkModelThirdviewlevel extends ConfmgtClassModelItem
{
	/**
	* View list alias
	*
	...
	* @since	1.6
	*/
	public function getTable($type = 'thirdviewlevel', $prefix = 'ConfmgtTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_confmgt.edit.viewlevel.data', array());
...
JLoader::register('ConfmgtModelThirdviewlevel', JPATH_ADMIN_CONFMGT .DS. 'fork' .DS. 'models' .DS. 'thirdviewlevel.php');
JLoader::load('ConfmgtModelThirdviewlevel');
// Fallback if no fork has been found
if (!class_exists('ConfmgtModelThirdviewlevel')){ class ConfmgtModelThirdviewlevel extends ConfmgtCkModelThirdviewlevel{} }
