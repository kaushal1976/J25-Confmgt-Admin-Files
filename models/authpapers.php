...
* @subpackage	Classes
*/
class ConfmgtCkModelAuthpapers extends ConfmgtClassModelList
{
	/**
	...
	*/
	public function populateState($ordering = null, $direction = null)
	{
		...
		parent::populateState('a.author_id', 'asc');
	}
...
JLoader::register('ConfmgtModelAuthpapers', JPATH_ADMIN_CONFMGT .DS. 'fork' .DS. 'models' .DS. 'authpapers.php');
JLoader::load('ConfmgtModelAuthpapers');
// Fallback if no fork has been found
if (!class_exists('ConfmgtModelAuthpapers')){ class ConfmgtModelAuthpapers extends ConfmgtCkModelAuthpapers{} }
