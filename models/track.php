...
class ConfmgtCkModelTrack extends ConfmgtClassModelItem
{
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'tracview', 'STRING');
	}
	...
	protected function prepareQuery(&$query, $pk)
	{
		...
		switch($this->getState('context'))
		{
			case 'track.trac':
				...
				//BASE FIELDS
				$this->addSelect(	'a.track_description,'
								.	'a.track_leader,'
								.	'a.track_name');
...
JLoader::register('ConfmgtModelTrack', JPATH_ADMIN_CONFMGT .DS. 'fork' .DS. 'models' .DS. 'track.php');
