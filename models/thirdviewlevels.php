...
* @subpackage	Classes
*/
class ConfmgtCkModelThirdviewlevels extends ConfmgtClassModelList
{
	/**
...
JLoader::register('ConfmgtModelThirdviewlevels', JPATH_ADMIN_CONFMGT .DS. 'fork' .DS. 'models' .DS. 'thirdviewlevels.php');
JLoader::load('ConfmgtModelThirdviewlevels');
// Fallback if no fork has been found
if (!class_exists('ConfmgtModelThirdviewlevels')){ class ConfmgtModelThirdviewlevels extends ConfmgtCkModelThirdviewlevels{} }
