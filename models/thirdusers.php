...
* @subpackage	Classes
*/
class ConfmgtCkModelThirdusers extends ConfmgtClassModelList
{
	/**
...
JLoader::register('ConfmgtModelThirdusers', JPATH_ADMIN_CONFMGT .DS. 'fork' .DS. 'models' .DS. 'thirdusers.php');
JLoader::load('ConfmgtModelThirdusers');
// Fallback if no fork has been found
if (!class_exists('ConfmgtModelThirdusers')){ class ConfmgtModelThirdusers extends ConfmgtCkModelThirdusers{} }
